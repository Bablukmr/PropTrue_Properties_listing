...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'admin.auth'], function () {
        ...
        Route::middleware('check.permission:featured_property')->group(function () {
            Route::get('properties', [PropertyListingController::class, 'list'])->name('admin.properties.list');
        });

        Route::middleware('check.permission:add_new_property')->group(function () {
        ...
        Route::middleware('check.permission:blog')->group(function () {
            // Blog admin routes
        ...
        Route::middleware('check.permission:career')->group(function () {
            // Career routes
        ...
        Route::get('rera-disclaimer', [LegalController::class, 'adminreradisclaimer'])->name('admin.reradesclemar');

        // For handling the form submission (POST request)
        Route::post('rera-disclaimer/update', [LegalController::class, 'adminreradisclaimerupdate'])->name('admin.reradesclemar.update');

       // Contact Details
        Route::get('contactdetails', [ContactDetailController::class, 'index'])->name('admin.contactdetails.index');
        Route::put('/admin/contactdetails/{id}', [ContactDetailController::class, 'update'])->name('contactdetails.update');
    ...
    Route::post('/{facility}/toggle-status', [FacilityController::class, 'toggleStatus'])->name('admin.facilities.toggleStatus');
});

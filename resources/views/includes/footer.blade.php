...
>>>>>>> 5920c52aed519dcafc7d8809b6fe0a3d306ac77d
        ...
        <div class="mt-16 border-t border-gray-700 pt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-400">
                <div>
                    <p class="mb-4">
                        PropTru is the leading commercial real estate marketplace connecting business owners, investors,
                        and real estate professionals with premium office spaces, retail locations, industrial
                        properties, and land for sale or lease across the United States.
                    </p>
                    <p class="mb-4">
                        Our comprehensive database features thousands of commercial listings with detailed property
                        information, high-resolution images, virtual tours, and market analytics to help you make
                        informed real estate decisions.
                    </p>
                </div>
                <div>
                    <p class="mb-4">
                        Whether you're looking to buy, sell, or lease commercial property, PropTru provides the tools
                        and resources you need. Our network of licensed commercial real estate brokers and agents are
                        available to assist with your transaction.
                    </p>
                    <p>
                        PropTru serves major markets including New York, Los Angeles, Chicago, Houston, Phoenix,
                        Philadelphia, San Antonio, San Diego, Dallas, and San Jose, with expanding coverage nationwide.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            <div class="text-gray-400 text-sm">
                <h4 class="font-semibold text-gray-300 mb-2">Legal Disclaimer:</h4>
                <p class="mb-4">
                    The information provided on this website does not constitute legal, financial, or professional real
                    estate advice. All property information is deemed reliable but not guaranteed and should be
                    independently verified. PropTru does not guarantee the accuracy of listing information, including
                    but not limited to square footage, pricing, or availability. All property measurements are
                    approximate.
                </p>

                <h4 class="font-semibold text-gray-300 mb-2">Equal Housing Opportunity:</h4>
                <p class="mb-4">
                    PropTru is committed to compliance with all federal, state, and local fair housing laws. We provide
                    equal professional service to all persons without regard to race, color, religion, sex, handicap,
                    familial status, national origin, sexual orientation, or gender identity.
                </p>

                <h4 class="font-semibold text-gray-300 mb-2">Licensing Information:</h4>
                <p>
                    PropTru, Inc. is a licensed real estate brokerage in all 50 states (License #1234567). Brokerage
                    services are provided by PropTru Realty Services, LLC. All agents listed on this site are licensed
                    professionals.
                </p>
            </div>
        </div>

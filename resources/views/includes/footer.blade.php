    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="mt-16 border-t border-gray-700 pt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 text-gray-400">
                <div>
                    <p class="mb-4">
                        PropTru is a leading real estate platform based in Patna, Bihar, connecting home buyers,
                        investors,
                        and property dealers with residential plots, flats, commercial spaces, and rental properties
                        across
                        the region.
                    </p>
                    <p class="mb-4">
                        Our extensive listings include verified properties with complete details, high-quality images,
                        and
        ...
        <div class="mt-12 border-t border-gray-700 pt-8">
            <div class="text-gray-400 text-sm">
                ...
                <p class="mb-4">
                    ...
                    should be verified independently. PropTru does not guarantee accuracy in details such as area,
                    price,
                ...
                <p class="mb-4">
                    PropTru is committed to equal housing access for all. We offer unbiased real estate services
                    regardless
                ...
                <p>
                    ...
                    property agents and partners associated with this platform hold valid licenses as per local
                    regulatory
                    standards.
                </p>
            </div>

                                    ...
                                    <tbody>
                                        @foreach ($blogs as $blog)
                                            <tr>
                                                ...
                                                <td>{{ $blog->date }}</td>
                                                <td>
                                                    {{ $blog->show_on_home ? 'Yes' : 'No' }}
                                                    <form action="{{ route('admin.blogs.toggleHomeView', $blog->id) }}"
                                                        method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit"
                                                            class="btn btn-sm {{ $blog->show_on_home ? 'btn-warning' : 'btn-success' }}">
                                                            {{ $blog->show_on_home ? 'Hide' : 'Show' }}
                                                        </button>
                                                    </form>
                                                </td>
                                                <td>

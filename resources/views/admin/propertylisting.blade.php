                                            ...
                                            <div class="card card-secondary" style="border-color: #b1b2b1;">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="master_properties_detais">Master Property Details</label>
                                                                <input type="text" class="form-control" id="master_properties_detais"
                                                                    name="master_properties_detais" placeholder="3-4 BHK, ..">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group">

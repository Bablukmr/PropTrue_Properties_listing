    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="/sico.png" alt="PropTrue" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @if ($admin->permission->blog)
                        <!-- ====BLOG Master ==== -->
                        <li
                            class="nav-item {{ Request::is('admin/user-permission*', 'admin/our_team*', 'admin/disabled_dates*', 'admin/booking_dates*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ Request::is('admin/timeslot*', 'admin/prices*', 'admin/disabled_dates*', 'admin/booking_dates*') ? 'active' : '' }}">
                               <i class="fas fa-users nav-icon"></i>
                                <p>

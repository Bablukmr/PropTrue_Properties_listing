    ...
    <body class="bg-white text-gray-700 font-sans overflow-x-hidden">
                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        <li class="inline-flex items-center">
                            <a href="{{ route('home') }}"
                                class="inline-flex items-center text-sm font-medium text-white hover:text-primary">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg text-gray-600 mb-6">
                            At Proptru, we've assembled a team of the most knowledgeable and dedicated real estate
                            professionals in the industry. With decades of combined experience, our team brings unparalleled
                            expertise to help you navigate the property market.
                        </p>
                        ...
                        <div class="space-y-4 mb-8">
                            <div class="flex items-start">
                                ...
                                <p class="ml-3 text-gray-600">
                                    <span class="font-semibold">Local Market Experts:</span> Deep knowledge of every
                            ...
                            <div class="flex items-start">
                                ...
                                <p class="ml-3 text-gray-600">
                                    <span class="font-semibold">Client-First Approach:</span> Your needs always come first
                            ...
                            <div class="flex items-start">
                                ...
                                <p class="ml-3 text-gray-600">
                                    <span class="font-semibold">Innovative Solutions:</span> Creative problem solvers who
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">
                    ...
                    <p class="text-gray-500 max-w-3xl mx-auto text-lg">
                        Meet the visionary leaders who guide Proptru's strategy and ensure we deliver exceptional service to
                        our clients.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    @foreach ($members as $mem)
                        ...
                        @if ($mem->user_type == 1)
                          <div
                                class="team-member-card bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl">
                                ...
                                <!-- Text Section -->
                                <div class="p-6">
                                    <!-- Name and Designation moved here -->
                                    <h3 class="text-xl font-bold text-gray-800 mb-1">{{ $mem->employee_name }}</h3>
                                    <p class="text-primary font-medium mb-3">{{ $mem->designation }}</p>
                                    ...
                                    <div class="flex space-x-4">
                                        @if ($mem->fb_id_link)
                                            <a href="{{ $mem->fb_id_link }}"
                                                class="social-icon text-gray-500 hover:text-primary" target="_blank">
                                                <!-- Facebook SVG -->
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="text-center mb-16">
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                        Our Key <span class="text-primary">People</span>
                    </h2>
                    <div class="mx-auto w-24 h-1 bg-gradient-to-r from-primary to-primary-dark rounded-full mb-6"></div>
                    <p class="text-gray-500 max-w-3xl mx-auto text-lg">
                        Meet the visionary leaders who guide Proptru's strategy and ensure we deliver exceptional service to

    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="bg-gradient-to-r from-[#d33593] to-[#48254a] py-20 text-white">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-xl max-w-2xl mx-auto">Get the best value for your property with our expert valuation and
        ...
        <div class="container mx-auto px-4 py-16">
            <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <form action="{{ route('property.sell.store') }}" method="POST" class="space-y-6"
                        ...
                        <input type="hidden" name="enquiry_type" value="sell">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="file" id="images" name="images[]" multiple accept="image/*"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition">
                            <p class="text-gray-500 text-sm mt-1">Upload high-quality images of your property (multiple
                                allowed)</p>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">We use market analysis to get you the best possible price for
                                        your property.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">We market your property across multiple platforms to reach the
                                        widest audience.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">We take care of all the legal documentation and paperwork for
                                        a smooth transaction.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="bg-primary/10 p-3 rounded-full mr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Our competitive commission rates mean more money in your
                                        pocket.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-green-50 border border-green-100 rounded-xl p-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-green-600 mb-3">Need to sell quickly? Our fast track service can help you
                                    sell your property in as little as 7 days.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-white p-6 rounded-xl shadow-md">
                        ...
                        <p class="text-gray-600 mb-4">"Sold my apartment in just 2 weeks for 5% above asking price. The
                            team was professional and made the process so easy."</p>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-md">
                        ...
                        <p class="text-gray-600 mb-4">"Excellent service from start to finish. They handled all the
                            paperwork and kept me informed throughout the entire process."</p>
                        <div class="flex items-center">
                            <div class="bg-primary/10 p-2 rounded-full mr-3">
                                <i class="fas fa-user text-primary"></i>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-md">
                        ...
                        <p class="text-gray-600 mb-4">"I was hesitant to sell my family home, but they made the experience
                            much easier than I expected. Got a great price too!"</p>
                        <div class="flex items-center">
                            <div class="bg-primary/10 p-2 rounded-full mr-3">
                                <i class="fas fa-user text-primary"></i>
                            </div>

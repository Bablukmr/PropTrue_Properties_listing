    ...
    <div class="min-h-screen bg-gray-50">
        ...
        @if (session('success'))
            <div class="alert-popup">
                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative max-w-md"
                    role="alert">
        ...
        <div class="bg-gradient-to-r from-[#d33593] to-[#48254a] py-20 text-white">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-xl max-w-2xl mx-auto">Whether you're buying, selling, or just exploring options, we're here
                    to
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Contact: +91{{ $contact->phone_contact }}<br>Sells: +91{{ $contact->phone_sell }}</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="bg-primary/10 p-3 rounded-full mr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{ $contact->email_contact }}<br>{{ $contact->email_sell }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Contact: +91{{ $contact->phone_contact }}<br>sales:
                                        +91{{ $contact->phone_sell }}</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="bg-primary/10 p-3 rounded-full mr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{ $contact->email_contact }}<br>{{ $contact->email_sell }}
                                    </p>
                                </div>
                            </div>
                        </div>

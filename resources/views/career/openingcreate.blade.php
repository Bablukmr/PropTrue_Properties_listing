    ...
    <div class="container my-4">
        ...
        <form action="{{ route('admin.career.opening.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div id="benefits-tags" class="mt-2"></div>
                <input type="hidden" name="benefits" id="benefits-hidden" value="{{ old('benefits') }}">
...
@section('extraJs')
    ...
    // Initialize with any existing benefits (for edit)
    if (hiddenInput.value) {
        benefits = hiddenInput.value.split(',');
        benefits.forEach(benefit => {
            if (benefit.trim()) {
                createTag(benefit.trim());
            }
        });
    }

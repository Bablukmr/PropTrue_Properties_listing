                        ...
                        <div
                            ...
                            <div class="md:w-2/3 p-4 flex flex-col">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($property->property_id || $property->rera_id)
                                        <div class="text-sm text-gray-500 mt-1">
                                            ...
                                            @if ($property->rera_id && $property->rera_status !== 'not_applicable')
                                ...
                                <div class="details-grid mb-4 py-2 border-t border-b border-gray-100">
                                    ...
                                    @if ($property->master_properties_detais)
                                        <div class="detail-item">
                                            <span class="text-xs text-gray-500">PROPERTY DETAILS</span>
                                            <span class="font-medium">{{ $property->master_properties_detais }}</span>
                                        </div>
                                    @endif
                                ...
                                <div class="mt-auto">
                                    <div
                                        class="price-section flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
                                        <div>
                                        ...
                                        <div class="flex flex-col items-end">
                                            <p
                                                class="text-sm font-normal {{ $property->availability === 'Immediate' ? 'text-green-600' : 'text-blue-600' }}">
